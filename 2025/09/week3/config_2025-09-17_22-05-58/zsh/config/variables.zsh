...
# ZSH Configuration - Siege Analytics ZSH System (NOT atomantic)
export ZSH_CONFIG_DIR="$HOME/.config/zsh"
export ZSH_MODULES_DIR="$ZSH_CONFIG_DIR/modules-new"  # NEW modular system
export ZSH_LEGACY_MODULES="$ZSH_CONFIG_DIR/modules"   # Legacy modules (archived)
export ZSH_CONFIG_MODULES="$ZSH_CONFIG_DIR/config"    # Config files
...
# Oh-My-Zsh Configuration - Siege Analytics setup
export ZSH_OMZSH_DIR="$HOME/.dotfiles/oh-my-zsh"      # Keep atomantic's path for compatibility
export ZSH_OMZSH_CUSTOM="$ZSH_CONFIG_DIR/oh-my-zsh-custom"  # Our custom overrides
